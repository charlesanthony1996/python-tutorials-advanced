...
""" hashed salted and pepppered """


def get_global_pepper() -> str:
    """
    Get the global secret pepper from secure memory
    The important thing is that it is not stored in the databaseß
    """
...
def main():
    ...
    print("plaintext")
    update_password_plaintext(db, user, "v3ry s3cure")
    verify_password_plaintext(user, "v3ry s3cure")
