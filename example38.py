...
def longest_increasing_subsequence(seq: Sequence[T]) -> List[T]:
    ...
    longest_subsequence_indices = make_subsequence_indices(prev_indices= idx_prev_longest, terminal_idx= idx_minimal[-1])
...
def test_longest_increasing_subsequence():
    ...
    assert longest_increasing_subsequence([0, 8, 4,12, 2,10, 6, 14, 1, 9, 5, 13, 3, 11, 7, 15]) == [0, 2, 6, 9, 11, 15]
